...
public class BizPaymentNotifyLog {
    ...
    public PayNotifyType getNotifyTypeEnum() {
        return PayNotifyType.fromCode(notifyType);
    }

    public PayNotifyProcessStatus getProcessStatusEnum() {
        return PayNotifyProcessStatus.fromCode(processStatus);
    }

...
public class GlobalExceptionHandler {
    ...
    public ApiResponse<Void> handleBusinessException(BusinessException ex) {
        log.warn("business exception {}", StructuredArguments.keyValue("event", "business_exception"), ex);
        return ApiResponse.fail(resolveMessage(ex, "business request failed"));
    }

    @ExceptionHandler(BindException.class)
    public ApiResponse<Void> handleBindException(BindException ex) {
        log.warn("bind exception {}", StructuredArguments.keyValue("event", "validation_exception"), ex);
    ...
    public ApiResponse<Void> handleException(Exception ex) {
        log.error("unexpected exception {}", StructuredArguments.keyValue("event", "unexpected_exception"), ex);
